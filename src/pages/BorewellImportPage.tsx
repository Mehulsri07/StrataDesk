...
export default function BorewellImportPage() {
  ...
  return (
    <div className="min-h-screen bg-void text-foam font-sans selection:bg-core/30 overflow-y-auto">
      ...
      <main className="max-w-5xl mx-auto p-6 grid grid-cols-1 lg:grid-cols-12 gap-8 pb-16">
